...
typedef struct {
    ...
    // Absolute tuning envelope, only reachable with overclockEnabled. These
    // are conservative guesses (no public BM13xx datasheet): the preset
    // ladders, the BAP's old fixed 700-1400 mV / 100-800 MHz envelope minus
    // margin, TPS546_INIT_VOUT_MIN = 1.0 V as the floor. 0 = not configured,
    // which keeps preset-only behaviour even when overclocked.
    uint16_t oc_min_voltage_mv;
    uint16_t oc_max_voltage_mv;
    uint16_t oc_min_frequency_mhz;
    uint16_t oc_max_frequency_mhz;
...
static const AsicConfig ASIC_BM1397 = { .id = BM1397, .name = "BM1397", .chip_id = 1397, .default_frequency_mhz = 425, .frequency_options = BM1397_FREQUENCY_OPTIONS, .default_voltage_mv = 1400, .voltage_options = BM1397_VOLTAGE_OPTIONS, .oc_min_voltage_mv = 1000, .oc_max_voltage_mv = 1550, .oc_min_frequency_mhz = 200, .oc_max_frequency_mhz = 650, .difficulty = 256, .core_count = 168, .small_core_count =  672, .hash_domains = 1, .hashrate_test_percentage_target = 0.85, .default_asic_timeout = 20};
static const AsicConfig ASIC_BM1366 = { .id = BM1366, .name = "BM1366", .chip_id = 1366, .default_frequency_mhz = 485, .frequency_options = BM1366_FREQUENCY_OPTIONS, .default_voltage_mv = 1200, .voltage_options = BM1366_VOLTAGE_OPTIONS, .oc_min_voltage_mv = 1000, .oc_max_voltage_mv = 1350, .oc_min_frequency_mhz = 200, .oc_max_frequency_mhz = 650, .difficulty = 256, .core_count = 112, .small_core_count =  894, .hash_domains = 4, .hashrate_test_percentage_target = 0.85, .default_asic_timeout = 2000};
static const AsicConfig ASIC_BM1368 = { .id = BM1368, .name = "BM1368", .chip_id = 1368, .default_frequency_mhz = 490, .frequency_options = BM1368_FREQUENCY_OPTIONS, .default_voltage_mv = 1166, .voltage_options = BM1368_VOLTAGE_OPTIONS, .oc_min_voltage_mv = 1000, .oc_max_voltage_mv = 1350, .oc_min_frequency_mhz = 200, .oc_max_frequency_mhz = 650, .difficulty = 256, .core_count =  80, .small_core_count = 1276, .hash_domains = 4, .hashrate_test_percentage_target = 0.80, .default_asic_timeout = 500};
static const AsicConfig ASIC_BM1370 = { .id = BM1370, .name = "BM1370", .chip_id = 1370, .default_frequency_mhz = 525, .frequency_options = BM1370_FREQUENCY_OPTIONS, .default_voltage_mv = 1150, .voltage_options = BM1370_VOLTAGE_OPTIONS, .oc_min_voltage_mv = 1000, .oc_max_voltage_mv = 1350, .oc_min_frequency_mhz = 200, .oc_max_frequency_mhz = 800, .difficulty = 256, .core_count = 128, .small_core_count = 2040, .hash_domains = 4, .hashrate_test_percentage_target = 0.85, .default_asic_timeout = 500};
static const AsicConfig ASIC_BM1370XP = { .id = BM1370, .name = "BM1370", .chip_id = 1370, .default_frequency_mhz = 400, .frequency_options = BM1370_FRQUENCY_XP_OPTIONS, .default_voltage_mv = 1150, .voltage_options = BM1370_VOLTAGE_OPTIONS, .oc_min_voltage_mv = 1000, .oc_max_voltage_mv = 1350, .oc_min_frequency_mhz = 200, .oc_max_frequency_mhz = 800, .difficulty = 256, .core_count = 128, .small_core_count = 2040, .hash_domains = 4, .hashrate_test_percentage_target = 0.85, .default_asic_timeout = 500};
