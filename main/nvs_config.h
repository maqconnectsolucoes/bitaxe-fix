...
typedef enum {
    ...
    // Publicação de telemetria num broker MQTT externo (ver tasks/mqtt_task.c).
    NVS_CONFIG_MQTT_ENABLED,
    NVS_CONFIG_MQTT_HOST,
    NVS_CONFIG_MQTT_PORT,
    NVS_CONFIG_MQTT_USER,
    NVS_CONFIG_MQTT_PASS,
    NVS_CONFIG_MQTT_CA_CERT,
    NVS_CONFIG_MQTT_INTERVAL,
    NVS_CONFIG_MQTT_DEVICE_ID,
    NVS_CONFIG_COUNT
} NvsConfigKey;
