...
static Settings settings[NVS_CONFIG_COUNT] = {
    ...
    [NVS_CONFIG_ASIC_FREQUENCY]                        = {.nvs_key_name = "asicfrequency_f", .type = TYPE_FLOAT, .default_value = {.f   = CONFIG_ASIC_FREQUENCY},                       .rest_name = "frequency",                          .min = 1,  .max = 1000},
    [NVS_CONFIG_ASIC_VOLTAGE]                          = {.nvs_key_name = "asicvoltage",     .type = TYPE_U16,   .default_value = {.u16 = CONFIG_ASIC_VOLTAGE},                         .rest_name = "coreVoltage",                        .min = 1,  .max = 2000},
    [NVS_CONFIG_OVERCLOCK_ENABLED]                     = {.nvs_key_name = "oc_enabled",      .type = TYPE_BOOL,                                                                         .rest_name = "overclockEnabled",                   .min = 0,  .max = 1},
    [NVS_CONFIG_AUTOTUNE_ENABLED]                      = {.nvs_key_name = "autotune_en",     .type = TYPE_BOOL,                                                                         .rest_name = "autotuneEnabled",                    .min = 0,  .max = 1},
    [NVS_CONFIG_AUTOTUNE_FREQUENCY]                    = {.nvs_key_name = "autotune_freq",   .type = TYPE_FLOAT,                                                                        .rest_name = "autotuneFrequency",                  .min = 0,  .max = UINT16_MAX},
    ...
    [NVS_CONFIG_TEMP_TARGET]                           = {.nvs_key_name = "temptarget",      .type = TYPE_U16,   .default_value = {.u16 = 60},                                          .rest_name = "temptarget",                         .min = 35, .max = 72},
    ...
    // MQTT: telemetria enviada para um broker externo. mqttPass nunca é devolvida
    // pela API; o PATCH trata o literal "*****" como "manter a senha guardada"
    // (mesmo contrato das senhas de pool, ver update_pool_nvs em http_server.c).
    [NVS_CONFIG_MQTT_ENABLED]                          = {.nvs_key_name = "mqtt_en",          .type = TYPE_BOOL,  .default_value = {.b = false},                                         .rest_name = "mqttEnabled",                        .min = 0,  .max = 1},
    [NVS_CONFIG_MQTT_HOST]                             = {.nvs_key_name = "mqtt_host",       .type = TYPE_STR,   .default_value = {.str = ""},                                          .rest_name = "mqttHost",                           .min = 0,  .max = 128},
    [NVS_CONFIG_MQTT_PORT]                             = {.nvs_key_name = "mqtt_port",       .type = TYPE_U16,   .default_value = {.u16 = 8883},                                        .rest_name = "mqttPort",                           .min = 1,  .max = UINT16_MAX},
    [NVS_CONFIG_MQTT_USER]                             = {.nvs_key_name = "mqtt_user",       .type = TYPE_STR,   .default_value = {.str = ""},                                          .rest_name = "mqttUser",                           .min = 0,  .max = 64},
    [NVS_CONFIG_MQTT_PASS]                             = {.nvs_key_name = "mqtt_pass",       .type = TYPE_STR,   .default_value = {.str = ""},                                          .rest_name = "mqttPass",                           .min = 0,  .max = 128},
    [NVS_CONFIG_MQTT_CA_CERT]                          = {.nvs_key_name = "mqtt_ca",         .type = TYPE_STR,   .default_value = {.str = ""},                                          .rest_name = "mqttCaCert",                         .min = 0,  .max = 3000},
    [NVS_CONFIG_MQTT_INTERVAL]                         = {.nvs_key_name = "mqtt_interval",   .type = TYPE_U16,   .default_value = {.u16 = 30},                                          .rest_name = "mqttInterval",                       .min = 5,  .max = 3600},
    [NVS_CONFIG_MQTT_DEVICE_ID]                        = {.nvs_key_name = "mqtt_devid",      .type = TYPE_STR,   .default_value = {.str = ""},                                          .rest_name = "mqttDeviceId",                      .min = 0,  .max = 64},
