...
export class LogsComponent implements OnInit, OnDestroy, AfterViewChecked {
  ...
  // Set when a line is appended; ngAfterViewChecked runs on every
  // change-detection pass and must not issue a smooth scrollTo each time.
  ...
  ngAfterViewChecked(): void {
    if (this.stopScroll || !this.pendingScroll) {
      return;
    }
