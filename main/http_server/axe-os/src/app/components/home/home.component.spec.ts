...
describe('HomeComponent', () => {
  ...
  it('stops persisting chart data sources after destroy', () => {
    expect(component.form).toBeTruthy();
    const setItem = spyOn(TestBed.inject(LocalStorageService), 'setItem');
    fixture.destroy();
    component.form.patchValue({ chartY1Data: 'power' });
