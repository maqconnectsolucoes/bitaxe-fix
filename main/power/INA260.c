 ...
 */
// Consecutive failed I2C reads across the readers below (they return the
// last good value on failure); see INA260_get_read_failures().
static uint32_t read_failures = 0;

uint32_t INA260_get_read_failures(void)
{
