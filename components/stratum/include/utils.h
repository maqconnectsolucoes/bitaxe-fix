...
// Resume a SHA-256 computation from a previously computed midstate (the
// state after the first 64-byte block) and hash the remaining data. Used to
// avoid rehashing the first block on the hot nonce-validation path.
