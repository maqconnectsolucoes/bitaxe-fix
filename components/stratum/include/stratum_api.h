...
// extranonce1 (hex) is copied into a fixed stack buffer by create_jobs_task;
// pools use 4-16 bytes (8-32 hex chars), so 64 leaves generous headroom.
#define MAX_EXTRANONCE_STR_LEN 64
