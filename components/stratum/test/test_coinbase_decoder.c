...
TEST_CASE("Varint decode truncated FF format does not read past buffer", "[coinbase_decoder]")
{
    // 0xFF claims 8 more bytes, but only 1 remains - must not read out of bounds
